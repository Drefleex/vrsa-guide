...
const CATS = [
  { k:'restaurante', icon:'🍽️', color:'#D32F2F', bg:'#FFEBEE', label:{PT:'Restaurantes', EN:'Restaurants', ES:'Restaurantes', FR:'Restaurants',  DE:'Restaurants'  } },
  { k:'pastelaria',  icon:'☕',  color:'#5D4037', bg:'#EFEBE9', label:{PT:'Cafés',        EN:'Cafés',        ES:'Cafés',        FR:'Cafés',        DE:'Cafés'        } },
  { k:'gelataria',   icon:'🍦',  color:'#D81B60', bg:'#FCE4EC', label:{PT:'Gelados',      EN:'Ice Cream',    ES:'Helados',      FR:'Glaces',       DE:'Eis'          } },
  { k:'hamburgaria', icon:'🍔',  color:'#E65100', bg:'#FFF3E0', label:{PT:'Burgers',      EN:'Burgers',      ES:'Burgers',      FR:'Burgers',      DE:'Burger'       } },
  { k:'pizzaria',    icon:'🍕',  color:'#C62828', bg:'#FFEBEE', label:{PT:'Pizzarias',    EN:'Pizza',        ES:'Pizzerías',    FR:'Pizzerias',    DE:'Pizzerien'    } },
  { k:'kebab',       icon:'🌯',  color:'#6D4C41', bg:'#EFEBE9', label:{PT:'Kebab',        EN:'Kebab',        ES:'Kebab',        FR:'Kebab',        DE:'Kebab'        } },
  { k:'cultura',     icon:'🏛️', color:'#1565C0', bg:'#E3F2FD', label:{PT:'Cultura',      EN:'Culture',      ES:'Cultura',      FR:'Culture',      DE:'Kultur'       } },
  { k:'estado',      icon:'🏢',  color:'#37474F', bg:'#ECEFF1', label:{PT:'Estado',       EN:'Gov.',         ES:'Estado',       FR:'Admin.',       DE:'Behörden'     } },
  { k:'praia',       icon:'🏖️', color:'#0277BD', bg:'#E1F5FE', label:{PT:'Praias',       EN:'Beaches',      ES:'Playas',       FR:'Plages',       DE:'Strände'      } },
  { k:'natureza',    icon:'🌿',  color:'#2E7D32', bg:'#E8F5E9', label:{PT:'Natureza',     EN:'Nature',       ES:'Naturaleza',   FR:'Nature',       DE:'Natur'        } },
  { k:'mercado',     icon:'🛒',  color:'#1B5E20', bg:'#E8F5E9', label:{PT:'Mercados',     EN:'Markets',      ES:'Mercados',     FR:'Marchés',      DE:'Märkte'       } },
  { k:'hotel',       icon:'🏨',  color:'#AD1457', bg:'#FCE4EC', label:{PT:'Hotéis',       EN:'Hotels',       ES:'Hoteles',      FR:'Hôtels',       DE:'Hotels'       } },
  { k:'banco',       icon:'🏦',  color:'#0D47A1', bg:'#E3F2FD', label:{PT:'Bancos/ATM',  EN:'Banks/ATM',    ES:'Bancos/ATM',   FR:'Banques/ATM',  DE:'Banken/ATM'   } },
  { k:'farmacia',    icon:'💊',  color:'#00695C', bg:'#E0F2F1', label:{PT:'Farmácias',    EN:'Pharmacy',     ES:'Farmacias',    FR:'Pharmacies',   DE:'Apotheken'    } },
  { k:'parking',     icon:'🅿️', color:'#1565C0', bg:'#E3F2FD', label:{PT:'Parking',      EN:'Parking',      ES:'Parking',      FR:'Parking',      DE:'Parkplatz'    } },
  { k:'combustivel', icon:'⛽',  color:'#E65100', bg:'#FFF3E0', label:{PT:'Combustível',  EN:'Fuel',         ES:'Gasolina',     FR:'Carburant',    DE:'Tankstelle'   } },
  { k:'transporte',  icon:'🚌',  color:'#4A148C', bg:'#F3E5F5', label:{PT:'Transportes',  EN:'Transport',    ES:'Transporte',   FR:'Transport',    DE:'Verkehr'      } },
  { k:'compras',     icon:'🛍️', color:'#6A1B9A', bg:'#F3E5F5', label:{PT:'Compras',      EN:'Shopping',     ES:'Compras',      FR:'Shopping',     DE:'Einkaufen'    } },
  { k:'saude',       icon:'🏥',  color:'#00838F', bg:'#E0F7FA', label:{PT:'Saúde',        EN:'Health',       ES:'Salud',        FR:'Santé',        DE:'Gesundheit'   } },
  { k:'bar',         icon:'🍺',  color:'#B45309', bg:'#FEF3C7', label:{PT:'Bares',        EN:'Bars',         ES:'Bares',        FR:'Bars',         DE:'Bars'         } },
  { k:'sushi',       icon:'🍣',  color:'#BE123C', bg:'#FFF1F2', label:{PT:'Sushi',        EN:'Sushi',        ES:'Sushi',        FR:'Sushi',        DE:'Sushi'        } },
  { k:'loja',        icon:'🏪',  color:'#7C3AED', bg:'#EDE9FE', label:{PT:'Lojas',        EN:'Shops',        ES:'Tiendas',      FR:'Boutiques',    DE:'Geschäfte'    } },
  { k:'carregador',  icon:'⚡',  color:'#16A34A', bg:'#DCFCE7', label:{PT:'Carregadores', EN:'EV Charging',  ES:'Cargadores',   FR:'Recharge VE',  DE:'E-Laden'      } },
  { k:'bombeiro',    icon:'🚒',  color:'#DC2626', bg:'#FEF2F2', label:{PT:'Bombeiros',    EN:'Fire Station', ES:'Bomberos',     FR:'Pompiers',     DE:'Feuerwehr'    } },
  { k:'policia',     icon:'👮',  color:'#1D4ED8', bg:'#EFF6FF', label:{PT:'Polícia',      EN:'Police',       ES:'Policía',      FR:'Police',       DE:'Polizei'      } },
]
