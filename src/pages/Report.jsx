...
export default function Report({ lang }) {
  ...
  if (sent) {
    return (
      <div className="page" style={{ display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', padding:'40px 24px', textAlign:'center' }}>
        ...
        <div style={{ fontSize:13, color:'var(--ink-40)', lineHeight:1.7, marginBottom:copied ? 12 : 32 }}>{copied ? t.sentCopied : t.sentSub}</div>
        {copied && <div style={{ fontSize:12, color:'var(--ink-20)', marginBottom:32 }}>{CAMARA_EMAIL}</div>}
  ...
  return (
    <div className="page" style={{ display:'flex', flexDirection:'column' }}>
      ...
      {/* Header */}
      <div style={{ background:'var(--primary)', padding:'16px 18px 18px', paddingTop:'calc(16px + env(safe-area-inset-top,0px))', flexShrink:0 }}>
