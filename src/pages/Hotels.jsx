      ...
      <div className="page" style={{ display:'flex', flexDirection:'column' }}>
        ...
        <div style={{ flex:1, overflowY:'auto', padding:'18px 20px 40px' }}>
          ...
          <div style={{ display:'flex', gap:8 }}>
            <button onClick={() => window.location.assign(r.book, '_blank','noopener,noreferrer')} style={{ flex:1, padding:'13px 0', background:'var(--navy)', color:'#fff', border:'none', borderRadius:14, fontSize:14, fontWeight:800, cursor:'pointer', display:'flex', alignItems:'center', justifyContent:'center', gap:8 }}>🛏️ {t.book}</button>
            <button aria-label={t.navigate} onClick={() => window.location.assign('https://www.google.com/maps/dir/?api=1&destination='+detail.lat+','+detail.lng, '_blank','noopener,noreferrer')} style={{ width:50, height:50, background:'var(--blue-lt)', border:'none', borderRadius:14, fontSize:20, cursor:'pointer', display:'flex', alignItems:'center', justifyContent:'center' }}>🧭</button>
